...
public class ProductCatlogServicesController {
	...
	@RequestMapping(method=RequestMethod.GET, value={"/allProductsJSON"},
	...
	@RequestMapping(value={"/allProductXML"},produces=MediaType.APPLICATION_XML_VALUE)
	...
	public ResponseEntity<String> acceptProductDetails(@ModelAttribute Product product){
		product=onlineShopServices.acceptProductDetails(product);
		return new ResponseEntity<>("Product details successfully added productId :- "+product.getProductId(),HttpStatus.OK);
	}
	...
	@RequestMapping(value="/addProductsBulkJSON", method=RequestMethod.POST,
